 ...
 * 반별로 각 학생의 국영수 총점을 산출해 반 이름 총점을 출력하는 프로그램
 * 
 * 
 * 
 */
...
public class CollectionExer {
	public static void mnain(String[] args) {
		...
		StudentScore s32 = new StudentScore(3, 2, "진길동", 30, 30, 30, 0);
		StudentScore s33 = new StudentScore(3, 3, "성길동", 20, 20, 20, 0);
		
		Map<String, StudentScore>map = new TreeMap<String, StudentScore>();
