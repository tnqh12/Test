...
//				new StudentScoreUpgrade("홍길동",100,90,70),
//				new StudentScoreUpgrade("강감찬",90,80,60),
//				new StudentScoreUpgrade("이순신",80,70,50)
//		};

		List<StudentScoreUpgrade> ssList = new ArrayList<StudentScoreUpgrade>();
		ssList.add(new StudentScoreUpgrade("홍길동", 100, 90, 70));
		ssList.add(new StudentScoreUpgrade("강감찬", 90, 80, 60));
		ssList.add(new StudentScoreUpgrade("이순신", 80, 70, 50));
